...
@section('content')
			...
			<div class="row">
				...
				<div class="contentdownload">
					...
					<div class="titleafter">
						<h1>Thanks for your Download @if (isset($msg)) {!!$msg!!} @endif </h1>
						
						<h3>your download should be starting momentarily</h3>
					...
					<div class="col-sm-12">
						...
						<?php 
					    	...
					    	foreach($images as $item): ?>
						    	<div class="item_larger animated single-left col-sm-3" data-id="">
	...
	@if ((isset($id)) && (Session::get('media_id') ==$id))
	<!-- BEGIN JS FRAMEWORK -->
	<?php Session::forget('media_id');?>
	<script type="text/javascript">
		$(document).ready(function () {
			var callDownload = function(){
				var ids = $('.spanHidden').attr("image-id");
				location.href="../imgdownload/" + ids;
	        }
	        setTimeout(callDownload,3000);
	    });
	</script>
	@else
		<script type="text/javascript">
			$(document).ready(function () {
				var callDownload = function(){
					var ids = $('.spanHidden').attr("image-id");
					location.href="../downloadpage/" + ids;
		        }
		        setTimeout(callDownload,3000);
		    });
		</script>	
