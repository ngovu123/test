		...
		<div class="container">
			<div class="row">
				<div class="cntabout">
					...
					<h3 style="margin-top:0px; margin-bottom:0px;"><i class="glyphicon glyphicon-info-sign" aria-hidden="true"></i> <b>Rules Page</b></h3><br />
					<div class="container adminpage">
						<div class="col-sm-12 cntaddMedia" style="padding:0px;">
							...
							@endif
		                    {!! Form::open(array('action' => array('AdminHomeController@updaterules') , 'class'=>'form-horizontal formabout','enctype'=>'multipart/form-data')) !!}
								...
								<div class="form-row" style="text-align:right;">
									{!!Form::submit('Update Riles Page', array('id'=>'submit', 'class'=>'btn btn-success submit-media'))!!}
								</div>
							{!! Form::close() !!}
						</div>
					</div>
