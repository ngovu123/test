    ...
    <div class="row">
        <div class="cntadmin"> 
            <div class="adminpage">
                ...
                <h3><i class="glyphicon glyphicon-download-alt" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;<b> Edit media </b></h3>
                    {!! Form::open(array('action' => array('HomeController@editmedia',$media->slug), 'class'=>'form-horizontal formadddownload','enctype'=>'multipart/form-data')) !!}
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row">                              
                                <div class="upimage">
                                    <label for="upimage">Select New Image If Update</label>
                                    <input type="text" name="upimage" id="upimage_name" value="{{ old('upimage')}}"  readonly class="form-control" style="width: 500px; float: left;"> <a class="btn btn-primary" id="select_img" data-toggle="modal" href='#modal-cropimg' style="float: left;">Select</a> <div class="cropped"></div> 
                                    {!! $errors->first('upimage', '<span class="help-inline" style="color:red;">:message</span>') !!}                                   
                                </div>                              
                            </div>
                        </div>
                        <div class="form-row">
                            <label for="input-id">Images detail</label>
                            <?php $stt=0; ?>
                            <div class="row">
                        ...
                        <div class="form-row">
                            {!!Form::submit('Edit Download', array('id'=>'submit', 'class'=>'btn btn-success submit-media'))!!}
                        </div>
                    {!! Form::close() !!}
                </div>
                <!-- modal form -->
