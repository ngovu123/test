...
var offsetfrommouse=[20,15]; //image x,y offsets from cursor position in pixels. Enter 0,0 for no offset
var displayduration=0; //duration in seconds image should remain visible. 0 for always.

var defaultimageheight = 640;	// maximum image size.
var defaultimagewidth = 700;	// maximum image size.
